    ...
    <>
      <footer className={footerClasses}>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
              ...
              <div className="text-${theme === 'dark' ? 'white' : 'black'}">+91 9999-9999-99</div>
            </div>
            <div className="col-lg-4 mr-auto text-center">
              <FaEnvelope className={iconClasses} />
              <a className="d-block" href="mailto:aimlalumni@tmsl.com">aimlalumni@tmsl.com</a>
            </div>
          </div>
        </div>
        <br />
        <div className="container">
          ...
          <div className={`small text-center text-${theme === 'dark' ? 'gray-400' : 'muted'}`}>
            Copyright © 2024 - Vitalis  |  {devfooter} <a
              href="https://github.com/Vickym78/College-Almn-Management-system"
              target="_blank"
              rel="noreferrer"
            >
            Team Vitalis<GoVerified style={{ fontSize: "12px", marginLeft: "2px", color:"#03b3ff" }} />
            </a>
          </div>
        </div>
      </footer>
